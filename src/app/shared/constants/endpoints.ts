...
export const GET_MAP_DEVICE_BACKEND_ENDPOINT = 'maintenance/api/device/Configuration';
...
export const GET_DEVICE_CONFIGURATION_BY_ID_ENDPOINT = 'maintenance/api/device/DeviceConfiguration';
