...
export const deviceSettings = [
    ...
    { name: 'Firmware', key: 'firmware', value: '', placeholder: 'Update URL' },
    { name: 'Ignition On Interval', key: 'at', value: '', placeholder: 'Update Ignition On' },
    { name: 'Ignition Off Interval', key: 'st', value: '', placeholder: 'Update Ignition Off' },
